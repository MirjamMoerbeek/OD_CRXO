...
################################################################################################################################  
  output$ResultsTable <- DT::renderDataTable({
    ...
    colnames(results)=c("number of periods","RE for fixed number of clusters","N for budgetary constraint", "costs for budgetary constraint", "RE for budgetary constraint")    # column names in results matrix 
...
################################################################################################################################  
  output$ResultsTable2 <- DT::renderDataTable({
    ...
    colnames(results)=c("order of treatments","nr.switches","RE for fixed number of clusters","N for budgetary constraint", "costs for budgetary constraint", "RE for budgetary constraint")  # column names in results matrix 
